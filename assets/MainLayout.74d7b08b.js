import{Q as V}from"./QBtn.5f105828.js";import{g as _1,s as S1,c as J1,u as n2,a as c2,b as t2,d as e2,e as l2,f as X,Q as q1,h as U}from"./QResizeObserver.c81f9217.js";import{u as a2,Q as z2,a as J}from"./use-timeout.70dd5bfa.js";import{u as m2,a as o2,_ as i2}from"./plugin-vue_export-helper.9aaca751.js";import{c as r2,a as Y,n as P1,l as s2,b as n1,p as d1,d as B1,s as p1,e as w1,f as u1,g as h2,h as b1,i as d2,j as v1,k as A1,r as _,m as d,w as y,o as E1,q as T1,t as D1,u as j,v as B,x as $1,y as p2,z as y1,A as u2,B as v2,C as f2,D as M2,E as g2,F as w2,G as f1,H as c1,I as b2,J as y2,K as C2,L as $,M as a1,N as t1,O as i,P as C,Q as L2,R as x2,S as F,T as q,U as e1,V as Q}from"./index.91e5b6a8.js";import{Q as k2}from"./QPageContainer.487d1095.js";import{R as l1}from"./use-router-link.38700fb1.js";function M1(c,a,z){const r=w1(c);let n,t=r.left-a.event.x,o=r.top-a.event.y,f=Math.abs(t),p=Math.abs(o);const m=a.direction;m.horizontal===!0&&m.vertical!==!0?n=t<0?"left":"right":m.horizontal!==!0&&m.vertical===!0?n=o<0?"up":"down":m.up===!0&&o<0?(n="up",f>p&&(m.left===!0&&t<0?n="left":m.right===!0&&t>0&&(n="right"))):m.down===!0&&o>0?(n="down",f>p&&(m.left===!0&&t<0?n="left":m.right===!0&&t>0&&(n="right"))):m.left===!0&&t<0?(n="left",f<p&&(m.up===!0&&o<0?n="up":m.down===!0&&o>0&&(n="down"))):m.right===!0&&t>0&&(n="right",f<p&&(m.up===!0&&o<0?n="up":m.down===!0&&o>0&&(n="down")));let l=!1;if(n===void 0&&z===!1){if(a.event.isFirst===!0||a.event.lastDir===void 0)return{};n=a.event.lastDir,l=!0,n==="left"||n==="right"?(r.left-=t,f=0,t=0):(r.top-=o,p=0,o=0)}return{synthetic:l,payload:{evt:c,touch:a.event.mouse!==!0,mouse:a.event.mouse===!0,position:r,direction:n,isFirst:a.event.isFirst,isFinal:z===!0,duration:Date.now()-a.event.time,distance:{x:f,y:p},offset:{x:t,y:o},delta:{x:r.left-a.event.lastX,y:r.top-a.event.lastY}}}}let _2=0;var g1=r2({name:"touch-pan",beforeMount(c,{value:a,modifiers:z}){if(z.mouse!==!0&&Y.has.touch!==!0)return;function r(t,o){z.mouse===!0&&o===!0?h2(t):(z.stop===!0&&p1(t),z.prevent===!0&&B1(t))}const n={uid:"qvtp_"+_2++,handler:a,modifiers:z,direction:_1(z),noop:P1,mouseStart(t){S1(t,n)&&s2(t)&&(n1(n,"temp",[[document,"mousemove","move","notPassiveCapture"],[document,"mouseup","end","passiveCapture"]]),n.start(t,!0))},touchStart(t){if(S1(t,n)){const o=t.target;n1(n,"temp",[[o,"touchmove","move","notPassiveCapture"],[o,"touchcancel","end","passiveCapture"],[o,"touchend","end","passiveCapture"]]),n.start(t)}},start(t,o){if(Y.is.firefox===!0&&d1(c,!0),n.lastEvt=t,o===!0||z.stop===!0){if(n.direction.all!==!0&&(o!==!0||n.modifiers.mouseAllDir!==!0&&n.modifiers.mousealldir!==!0)){const m=t.type.indexOf("mouse")!==-1?new MouseEvent(t.type,t):new TouchEvent(t.type,t);t.defaultPrevented===!0&&B1(m),t.cancelBubble===!0&&p1(m),Object.assign(m,{qKeyEvent:t.qKeyEvent,qClickOutside:t.qClickOutside,qAnchorHandled:t.qAnchorHandled,qClonedBy:t.qClonedBy===void 0?[n.uid]:t.qClonedBy.concat(n.uid)}),n.initialEvent={target:t.target,event:m}}p1(t)}const{left:f,top:p}=w1(t);n.event={x:f,y:p,time:Date.now(),mouse:o===!0,detected:!1,isFirst:!0,isFinal:!1,lastX:f,lastY:p}},move(t){if(n.event===void 0)return;const o=w1(t),f=o.left-n.event.x,p=o.top-n.event.y;if(f===0&&p===0)return;n.lastEvt=t;const m=n.event.mouse===!0,l=()=>{r(t,m);let v;z.preserveCursor!==!0&&z.preservecursor!==!0&&(v=document.documentElement.style.cursor||"",document.documentElement.style.cursor="grabbing"),m===!0&&document.body.classList.add("no-pointer-events--children"),document.body.classList.add("non-selectable"),J1(),n.styleCleanup=u=>{if(n.styleCleanup=void 0,v!==void 0&&(document.documentElement.style.cursor=v),document.body.classList.remove("non-selectable"),m===!0){const T=()=>{document.body.classList.remove("no-pointer-events--children")};u!==void 0?setTimeout(()=>{T(),u()},50):T()}else u!==void 0&&u()}};if(n.event.detected===!0){n.event.isFirst!==!0&&r(t,n.event.mouse);const{payload:v,synthetic:u}=M1(t,n,!1);v!==void 0&&(n.handler(v)===!1?n.end(t):(n.styleCleanup===void 0&&n.event.isFirst===!0&&l(),n.event.lastX=v.position.left,n.event.lastY=v.position.top,n.event.lastDir=u===!0?void 0:v.direction,n.event.isFirst=!1));return}if(n.direction.all===!0||m===!0&&(n.modifiers.mouseAllDir===!0||n.modifiers.mousealldir===!0)){l(),n.event.detected=!0,n.move(t);return}const b=Math.abs(f),g=Math.abs(p);b!==g&&(n.direction.horizontal===!0&&b>g||n.direction.vertical===!0&&b<g||n.direction.up===!0&&b<g&&p<0||n.direction.down===!0&&b<g&&p>0||n.direction.left===!0&&b>g&&f<0||n.direction.right===!0&&b>g&&f>0?(n.event.detected=!0,n.move(t)):n.end(t,!0))},end(t,o){if(n.event!==void 0){if(u1(n,"temp"),Y.is.firefox===!0&&d1(c,!1),o===!0)n.styleCleanup!==void 0&&n.styleCleanup(),n.event.detected!==!0&&n.initialEvent!==void 0&&n.initialEvent.target.dispatchEvent(n.initialEvent.event);else if(n.event.detected===!0){n.event.isFirst===!0&&n.handler(M1(t===void 0?n.lastEvt:t,n).payload);const{payload:f}=M1(t===void 0?n.lastEvt:t,n,!0),p=()=>{n.handler(f)};n.styleCleanup!==void 0?n.styleCleanup(p):p()}n.event=void 0,n.initialEvent=void 0,n.lastEvt=void 0}}};if(c.__qtouchpan=n,z.mouse===!0){const t=z.mouseCapture===!0||z.mousecapture===!0?"Capture":"";n1(n,"main",[[c,"mousedown","mouseStart",`passive${t}`]])}Y.has.touch===!0&&n1(n,"main",[[c,"touchstart","touchStart",`passive${z.capture===!0?"Capture":""}`],[c,"touchmove","noop","notPassiveCapture"]])},updated(c,a){const z=c.__qtouchpan;z!==void 0&&(a.oldValue!==a.value&&(typeof value!="function"&&z.end(),z.handler=a.value),z.direction=_1(a.modifiers))},beforeUnmount(c){const a=c.__qtouchpan;a!==void 0&&(a.event!==void 0&&a.end(),u1(a,"main"),u1(a,"temp"),Y.is.firefox===!0&&d1(c,!1),a.styleCleanup!==void 0&&a.styleCleanup(),delete c.__qtouchpan)}});const R1=150;var S2=b1({name:"QDrawer",inheritAttrs:!1,props:{...n2,...m2,side:{type:String,default:"left",validator:c=>["left","right"].includes(c)},width:{type:Number,default:300},mini:Boolean,miniToOverlay:Boolean,miniWidth:{type:Number,default:57},noMiniAnimation:Boolean,breakpoint:{type:Number,default:1023},showIfAbove:Boolean,behavior:{type:String,validator:c=>["default","desktop","mobile"].includes(c),default:"default"},bordered:Boolean,elevated:Boolean,overlay:Boolean,persistent:Boolean,noSwipeOpen:Boolean,noSwipeClose:Boolean,noSwipeBackdrop:Boolean},emits:[...c2,"onLayout","miniState"],setup(c,{slots:a,emit:z,attrs:r}){const n=y1(),{proxy:{$q:t}}=n,o=o2(c,t),{preventBodyScroll:f}=l2(),{registerTimeout:p,removeTimeout:m}=a2(),l=d2(A1,v1);if(l===v1)return console.error("QDrawer needs to be child of QLayout"),v1;let b,g=null,v;const u=_(c.behavior==="mobile"||c.behavior!=="desktop"&&l.totalWidth.value<=c.breakpoint),T=d(()=>c.mini===!0&&u.value!==!0),L=d(()=>T.value===!0?c.miniWidth:c.width),M=_(c.showIfAbove===!0&&u.value===!1?!0:c.modelValue===!0),E=d(()=>c.persistent!==!0&&(u.value===!0||G1.value===!0));function W(e,s){if(D(),e!==!1&&l.animate(),S(0),u.value===!0){const x=l.instances[I.value];x!==void 0&&x.belowBreakpoint===!0&&x.hide(!1),P(1),l.isContainer.value!==!0&&f(!0)}else P(0),e!==!1&&r1(!1);p(()=>{e!==!1&&r1(!0),s!==!0&&z("show",e)},R1)}function h(e,s){K(),e!==!1&&l.animate(),P(0),S(H.value*L.value),s1(),s!==!0?p(()=>{z("hide",e)},R1):m()}const{show:w,hide:k}=t2({showing:M,hideOnRouteChange:E,handleShow:W,handleHide:h}),{addToHistory:D,removeFromHistory:K}=e2(M,k,E),G={belowBreakpoint:u,hide:k},R=d(()=>c.side==="right"),H=d(()=>(t.lang.rtl===!0?-1:1)*(R.value===!0?1:-1)),C1=_(0),O=_(!1),z1=_(!1),L1=_(L.value*H.value),I=d(()=>R.value===!0?"left":"right"),m1=d(()=>M.value===!0&&u.value===!1&&c.overlay===!1?c.miniToOverlay===!0?c.miniWidth:L.value:0),o1=d(()=>c.overlay===!0||c.miniToOverlay===!0||l.view.value.indexOf(R.value?"R":"L")!==-1||t.platform.is.ios===!0&&l.isContainer.value===!0),N=d(()=>c.overlay===!1&&M.value===!0&&u.value===!1),G1=d(()=>c.overlay===!0&&M.value===!0&&u.value===!1),H1=d(()=>"fullscreen q-drawer__backdrop"+(M.value===!1&&O.value===!1?" hidden":"")),O1=d(()=>({backgroundColor:`rgba(0,0,0,${C1.value*.4})`})),x1=d(()=>R.value===!0?l.rows.value.top[2]==="r":l.rows.value.top[0]==="l"),F1=d(()=>R.value===!0?l.rows.value.bottom[2]==="r":l.rows.value.bottom[0]==="l"),Q1=d(()=>{const e={};return l.header.space===!0&&x1.value===!1&&(o1.value===!0?e.top=`${l.header.offset}px`:l.header.space===!0&&(e.top=`${l.header.size}px`)),l.footer.space===!0&&F1.value===!1&&(o1.value===!0?e.bottom=`${l.footer.offset}px`:l.footer.space===!0&&(e.bottom=`${l.footer.size}px`)),e}),W1=d(()=>{const e={width:`${L.value}px`,transform:`translateX(${L1.value}px)`};return u.value===!0?e:Object.assign(e,Q1.value)}),K1=d(()=>"q-drawer__content fit "+(l.isContainer.value!==!0?"scroll":"overflow-auto")),N1=d(()=>`q-drawer q-drawer--${c.side}`+(z1.value===!0?" q-drawer--mini-animate":"")+(c.bordered===!0?" q-drawer--bordered":"")+(o.value===!0?" q-drawer--dark q-dark":"")+(O.value===!0?" no-transition":M.value===!0?"":" q-layout--prevent-focus")+(u.value===!0?" fixed q-drawer--on-top q-drawer--mobile q-drawer--top-padding":` q-drawer--${T.value===!0?"mini":"standard"}`+(o1.value===!0||N.value!==!0?" fixed":"")+(c.overlay===!0||c.miniToOverlay===!0?" q-drawer--on-top":"")+(x1.value===!0?" q-drawer--top-padding":""))),Y1=d(()=>{const e=t.lang.rtl===!0?c.side:I.value;return[[g1,X1,void 0,{[e]:!0,mouse:!0}]]}),j1=d(()=>{const e=t.lang.rtl===!0?I.value:c.side;return[[g1,k1,void 0,{[e]:!0,mouse:!0}]]}),I1=d(()=>{const e=t.lang.rtl===!0?I.value:c.side;return[[g1,k1,void 0,{[e]:!0,mouse:!0,mouseAllDir:!0}]]});function i1(){U1(u,c.behavior==="mobile"||c.behavior!=="desktop"&&l.totalWidth.value<=c.breakpoint)}y(u,e=>{e===!0?(b=M.value,M.value===!0&&k(!1)):c.overlay===!1&&c.behavior!=="mobile"&&b!==!1&&(M.value===!0?(S(0),P(0),s1()):w(!1))}),y(()=>c.side,(e,s)=>{l.instances[s]===G&&(l.instances[s]=void 0,l[s].space=!1,l[s].offset=0),l.instances[e]=G,l[e].size=L.value,l[e].space=N.value,l[e].offset=m1.value}),y(l.totalWidth,()=>{(l.isContainer.value===!0||document.qScrollPrevented!==!0)&&i1()}),y(()=>c.behavior+c.breakpoint,i1),y(l.isContainer,e=>{M.value===!0&&f(e!==!0),e===!0&&i1()}),y(l.scrollbarWidth,()=>{S(M.value===!0?0:void 0)}),y(m1,e=>{A("offset",e)}),y(N,e=>{z("onLayout",e),A("space",e)}),y(R,()=>{S()}),y(L,e=>{S(),h1(c.miniToOverlay,e)}),y(()=>c.miniToOverlay,e=>{h1(e,L.value)}),y(()=>t.lang.rtl,()=>{S()}),y(()=>c.mini,()=>{c.noMiniAnimation||c.modelValue===!0&&(Z1(),l.animate())}),y(T,e=>{z("miniState",e)});function S(e){e===void 0?T1(()=>{e=M.value===!0?0:L.value,S(H.value*e)}):(l.isContainer.value===!0&&R.value===!0&&(u.value===!0||Math.abs(e)===L.value)&&(e+=H.value*l.scrollbarWidth.value),L1.value=e)}function P(e){C1.value=e}function r1(e){const s=e===!0?"remove":l.isContainer.value!==!0?"add":"";s!==""&&document.body.classList[s]("q-body--drawer-toggle")}function Z1(){g!==null&&clearTimeout(g),n.proxy&&n.proxy.$el&&n.proxy.$el.classList.add("q-drawer--mini-animate"),z1.value=!0,g=setTimeout(()=>{g=null,z1.value=!1,n&&n.proxy&&n.proxy.$el&&n.proxy.$el.classList.remove("q-drawer--mini-animate")},150)}function X1(e){if(M.value!==!1)return;const s=L.value,x=X(e.distance.x,0,s);if(e.isFinal===!0){x>=Math.min(75,s)===!0?w():(l.animate(),P(0),S(H.value*s)),O.value=!1;return}S((t.lang.rtl===!0?R.value!==!0:R.value)?Math.max(s-x,0):Math.min(0,x-s)),P(X(x/s,0,1)),e.isFirst===!0&&(O.value=!0)}function k1(e){if(M.value!==!0)return;const s=L.value,x=e.direction===c.side,Z=(t.lang.rtl===!0?x!==!0:x)?X(e.distance.x,0,s):0;if(e.isFinal===!0){Math.abs(Z)<Math.min(75,s)===!0?(l.animate(),P(1),S(0)):k(),O.value=!1;return}S(H.value*Z),P(X(1-Z/s,0,1)),e.isFirst===!0&&(O.value=!0)}function s1(){f(!1),r1(!0)}function A(e,s){l.update(c.side,e,s)}function U1(e,s){e.value!==s&&(e.value=s)}function h1(e,s){A("size",e===!0?c.miniWidth:s)}return l.instances[c.side]=G,h1(c.miniToOverlay,L.value),A("space",N.value),A("offset",m1.value),c.showIfAbove===!0&&c.modelValue!==!0&&M.value===!0&&c["onUpdate:modelValue"]!==void 0&&z("update:modelValue",!0),E1(()=>{z("onLayout",N.value),z("miniState",T.value),b=c.showIfAbove===!0;const e=()=>{(M.value===!0?W:h)(!1,!0)};if(l.totalWidth.value!==0){T1(e);return}v=y(l.totalWidth,()=>{v(),v=void 0,M.value===!1&&c.showIfAbove===!0&&u.value===!1?w(!1):e()})}),D1(()=>{v!==void 0&&v(),g!==null&&(clearTimeout(g),g=null),M.value===!0&&s1(),l.instances[c.side]===G&&(l.instances[c.side]=void 0,A("size",0),A("offset",0),A("space",!1))}),()=>{const e=[];u.value===!0&&(c.noSwipeOpen===!1&&e.push(j(B("div",{key:"open",class:`q-drawer__opener fixed-${c.side}`,"aria-hidden":"true"}),Y1.value)),e.push($1("div",{ref:"backdrop",class:H1.value,style:O1.value,"aria-hidden":"true",onClick:k},void 0,"backdrop",c.noSwipeBackdrop!==!0&&M.value===!0,()=>I1.value)));const s=T.value===!0&&a.mini!==void 0,x=[B("div",{...r,key:""+s,class:[K1.value,r.class]},s===!0?a.mini():p2(a.default))];return c.elevated===!0&&M.value===!0&&x.push(B("div",{class:"q-layout__shadow absolute-full overflow-hidden no-pointer-events"})),e.push($1("aside",{ref:"content",class:N1.value,style:W1.value},x,"contentclose",c.noSwipeClose!==!0&&u.value===!0,()=>j1.value)),B("div",{class:"q-drawer-container"},e)}}});const{passive:V1}=f2,q2=["both","horizontal","vertical"];var B2=b1({name:"QScrollObserver",props:{axis:{type:String,validator:c=>q2.includes(c),default:"vertical"},debounce:[String,Number],scrollTarget:u2},emits:["scroll"],setup(c,{emit:a}){const z={position:{top:0,left:0},direction:"down",directionChanged:!1,delta:{top:0,left:0},inflectionPoint:{top:0,left:0}};let r=null,n,t;y(()=>c.scrollTarget,()=>{p(),f()});function o(){r!==null&&r();const b=Math.max(0,M2(n)),g=g2(n),v={top:b-z.position.top,left:g-z.position.left};if(c.axis==="vertical"&&v.top===0||c.axis==="horizontal"&&v.left===0)return;const u=Math.abs(v.top)>=Math.abs(v.left)?v.top<0?"up":"down":v.left<0?"left":"right";z.position={top:b,left:g},z.directionChanged=z.direction!==u,z.delta=v,z.directionChanged===!0&&(z.direction=u,z.inflectionPoint=z.position),a("scroll",{...z})}function f(){n=v2(t,c.scrollTarget),n.addEventListener("scroll",m,V1),m(!0)}function p(){n!==void 0&&(n.removeEventListener("scroll",m,V1),n=void 0)}function m(b){if(b===!0||c.debounce===0||c.debounce==="0")o();else if(r===null){const[g,v]=c.debounce?[setTimeout(o,c.debounce),clearTimeout]:[requestAnimationFrame(o),cancelAnimationFrame];r=()=>{v(g),r=null}}}const{proxy:l}=y1();return y(()=>l.$q.lang.rtl,o),E1(()=>{t=l.$el.parentNode,f()}),D1(()=>{r!==null&&r(),p()}),Object.assign(l,{trigger:m,getPosition:()=>z}),P1}}),T2=b1({name:"QLayout",props:{container:Boolean,view:{type:String,default:"hhh lpr fff",validator:c=>/^(h|l)h(h|r) lpr (f|l)f(f|r)$/.test(c.toLowerCase())},onScroll:Function,onScrollHeight:Function,onResize:Function},setup(c,{slots:a,emit:z}){const{proxy:{$q:r}}=y1(),n=_(null),t=_(r.screen.height),o=_(c.container===!0?0:r.screen.width),f=_({position:0,direction:"down",inflectionPoint:0}),p=_(0),m=_(w2.value===!0?0:f1()),l=d(()=>"q-layout q-layout--"+(c.container===!0?"containerized":"standard")),b=d(()=>c.container===!1?{minHeight:r.screen.height+"px"}:null),g=d(()=>m.value!==0?{[r.lang.rtl===!0?"left":"right"]:`${m.value}px`}:null),v=d(()=>m.value!==0?{[r.lang.rtl===!0?"right":"left"]:0,[r.lang.rtl===!0?"left":"right"]:`-${m.value}px`,width:`calc(100% + ${m.value}px)`}:null);function u(h){if(c.container===!0||document.qScrollPrevented!==!0){const w={position:h.position.top,direction:h.direction,directionChanged:h.directionChanged,inflectionPoint:h.inflectionPoint.top,delta:h.delta.top};f.value=w,c.onScroll!==void 0&&z("scroll",w)}}function T(h){const{height:w,width:k}=h;let D=!1;t.value!==w&&(D=!0,t.value=w,c.onScrollHeight!==void 0&&z("scrollHeight",w),M()),o.value!==k&&(D=!0,o.value=k),D===!0&&c.onResize!==void 0&&z("resize",h)}function L({height:h}){p.value!==h&&(p.value=h,M())}function M(){if(c.container===!0){const h=t.value>p.value?f1():0;m.value!==h&&(m.value=h)}}let E=null;const W={instances:{},view:d(()=>c.view),isContainer:d(()=>c.container),rootRef:n,height:t,containerHeight:p,scrollbarWidth:m,totalWidth:d(()=>o.value+m.value),rows:d(()=>{const h=c.view.toLowerCase().split(" ");return{top:h[0].split(""),middle:h[1].split(""),bottom:h[2].split("")}}),header:c1({size:0,offset:0,space:!1}),right:c1({size:300,offset:0,space:!1}),footer:c1({size:0,offset:0,space:!1}),left:c1({size:300,offset:0,space:!1}),scroll:f,animate(){E!==null?clearTimeout(E):document.body.classList.add("q-body--layout-animate"),E=setTimeout(()=>{E=null,document.body.classList.remove("q-body--layout-animate")},155)},update(h,w,k){W[h][w]=k}};if(b2(A1,W),f1()>0){let k=function(){h=null,w.classList.remove("hide-scrollbar")},D=function(){if(h===null){if(w.scrollHeight>r.screen.height)return;w.classList.add("hide-scrollbar")}else clearTimeout(h);h=setTimeout(k,300)},K=function(G){h!==null&&G==="remove"&&(clearTimeout(h),k()),window[`${G}EventListener`]("resize",D)},h=null;const w=document.body;y(()=>c.container!==!0?"add":"remove",K),c.container!==!0&&K("add"),y2(()=>{K("remove")})}return()=>{const h=C2(a.default,[B(B2,{onScroll:u}),B(q1,{onResize:T})]),w=B("div",{class:l.value,style:b.value,ref:c.container===!0?void 0:n,tabindex:-1},h);return c.container===!0?B("div",{class:"q-layout-container overflow-hidden",ref:n},[B(q1,{onResize:L}),B("div",{class:"absolute-full",style:g.value},[B("div",{class:"scroll",style:v.value},[w])])]):w}}});const $2={data(){return{currentYear:new Date().getFullYear()}}},R2={class:"footer-section"},V2={class:"footer-wrapper"},P2={class:"cus-column-2"},A2={class:"cus-nav-cont"},E2={class:"cus-column-4"};function D2(c,a,z,r,n,t){return $(),a1("div",R2,[a[5]||(a[5]=t1(`<div class="footer-background-image-cont-1"><svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760.000000 770.000000" preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,770.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"><path d="M3696 7679 c-65 -15 -157 -71 -228 -137 -62 -58 -69 -63 -101 -57
...
-240 177 -57 29 -107 52 -110 53 -3 0 -39 -34 -81 -77z"></path></g></svg></div>`,1))])}var G2=i2($2,[["render",D2]]);const H2={class:"cus-header-section"},O2={class:"cus-header-cont"},F2={href:"/"},Q2={class:"cus-header-logo-cont"},W2={key:0,class:""},K2={key:1,class:""},N2={key:0,class:"cus-header-nav"},Y2={class:"cus-drawer-wrapper"},j2={class:"cus-drawer-cont-md"},I2={class:"cus-drawer-nav"},l3={__name:"MainLayout",setup(c){const a=_(!1);function z(){a.value=!a.value}return(r,n)=>{const t=x2("router-view");return $(),F(T2,{class:"",view:"lHh Lpr lFf"},{default:q(()=>[i("div",H2,[i("div",O2,[i("a",F2,[i("div",Q2,[n[1]||(n[1]=i("img",{src:"images/klogo.png",alt:"Kachia Culture",class:""},null,-1)),r.$q.screen.lt.md?e1("",!0):($(),a1("h2",W2," Kachia Local Government Area ")),r.$q.screen.lt.md?($(),a1("h2",K2,"Kachia LGA")):e1("",!0)])]),r.$q.screen.lt.md?e1("",!0):($(),a1("div",N2,[C(V,{flat:"",label:"Home",to:{path:"/"}}),C(V,{flat:"",label:"About Kachia",to:{path:"/about"}}),C(V,{flat:"",label:"Culture",to:{path:"/culture"}}),C(V,{flat:"",label:"Contact",to:{path:"/contact"}}),n[2]||(n[2]=i("div",{class:"cus-e-gov-btn-cont"},[i("button",{style:{"--clr":"#7808d0"}},[i("span",{class:"button__icon-wrapper"},[i("svg",{viewBox:"0 0 14 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",class:"button__icon-svg",width:"10"},[i("path",{d:"M13.376 11.552l-.264-10.44-10.44-.24.024 2.28 6.96-.048L.2 12.56l1.488 1.488 9.432-9.432-.048 6.912 2.304.024z",fill:"currentColor"})]),i("svg",{viewBox:"0 0 14 15",fill:"none",width:"10",xmlns:"http://www.w3.org/2000/svg",class:"button__icon-svg button__icon-svg--copy"},[i("path",{d:"M13.376 11.552l-.264-10.44-10.44-.24.024 2.28 6.96-.048L.2 12.56l1.488 1.488 9.432-9.432-.048 6.912 2.304.024z",fill:"currentColor"})])]),Q(" E-Gov Portal ")])],-1))])),r.$q.screen.lt.md?($(),F(V,{key:1,flat:"",dense:"",round:"",icon:"menu",onClick:z,class:"q-hidden-md text-green-main"})):e1("",!0)])]),i("div",Y2,[C(S2,{modelValue:a.value,"onUpdate:modelValue":n[0]||(n[0]=o=>a.value=o),side:"left",overlay:"",class:"q-hidden-md-and-up cus-drawer-md"},{default:q(()=>[i("div",j2,[n[8]||(n[8]=i("div",{class:"cus-header-logo-cont"},[i("img",{src:"images/klogo-nbg.png",alt:"Kachia Culture",class:""}),i("h2",{class:""},"Kachia Local Government Area")],-1)),i("div",I2,[C(z2,null,{default:q(()=>[j(($(),F(J,{clickable:"",to:{path:"/"}},{default:q(()=>[C(U,null,{default:q(()=>n[3]||(n[3]=[Q("Home")])),_:1})]),_:1})),[[l1]]),j(($(),F(J,{clickable:"",to:{path:"/about"}},{default:q(()=>[C(U,null,{default:q(()=>n[4]||(n[4]=[Q("About Kachia")])),_:1})]),_:1})),[[l1]]),j(($(),F(J,{clickable:"",to:{path:"/culture"}},{default:q(()=>[C(U,null,{default:q(()=>n[5]||(n[5]=[Q("Culture")])),_:1})]),_:1})),[[l1]]),j(($(),F(J,{clickable:"",to:{path:"/contact"}},{default:q(()=>[C(U,null,{default:q(()=>n[6]||(n[6]=[Q("Contact")])),_:1})]),_:1})),[[l1]])]),_:1}),n[7]||(n[7]=i("div",{class:"cus-e-gov-btn-cont"},[i("button",{style:{"--clr":"#7808d0"}},[i("span",{class:"button__icon-wrapper"},[i("svg",{viewBox:"0 0 14 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",class:"button__icon-svg",width:"10"},[i("path",{d:"M13.376 11.552l-.264-10.44-10.44-.24.024 2.28 6.96-.048L.2 12.56l1.488 1.488 9.432-9.432-.048 6.912 2.304.024z",fill:"currentColor"})]),i("svg",{viewBox:"0 0 14 15",fill:"none",width:"10",xmlns:"http://www.w3.org/2000/svg",class:"button__icon-svg button__icon-svg--copy"},[i("path",{d:"M13.376 11.552l-.264-10.44-10.44-.24.024 2.28 6.96-.048L.2 12.56l1.488 1.488 9.432-9.432-.048 6.912 2.304.024z",fill:"currentColor"})])]),Q(" E-Gov Portal ")])],-1))])])]),_:1},8,["modelValue"])]),C(k2,null,{default:q(()=>[C(t)]),_:1}),C(G2)]),_:1})}}};export{l3 as default};
